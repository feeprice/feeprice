...
ggplot(data = eno_volume_mean, aes(x = year, y = avg_vol)) +
  geom_line() +
  geom_smooth(method = "lm") +
    annotate("text", x = 1973, y = 270000000, label = "-2.87 * 10^5 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
...
ggplot(data = flat_volume_mean, aes(x = year, y = avg_vol)) +
  geom_line() +
  geom_smooth(method = "lm") +
  annotate("text", x = 1950, y = 630000000, label = "-6.07 * 10^4 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
...
ggplot(data = flat_1981_volume, aes(x = year, y = avg_vol)) +
  geom_line() +
  geom_smooth(method = "lm") +
      annotate("text", x = 1990, y = 630000000, label = "1.06 * 10^5 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
...
ggplot(data = neuse_volume_mean, aes(x = year, y = avg_vol)) +
  geom_line() +
  geom_smooth(method = "lm") +
 annotate("text", x = 2012, y = 2900000000, label = "-1.09 * 10^7 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
...
ggplot(data = neuse_1981_volume, aes(x = year, y = avg_vol)) +
  geom_line() +
  geom_smooth(method = "lm") +
  annotate("text", x = 2012, y = 2800000000, label = "-5.36 * 10^6 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
...
ggplot(data = combined, aes(x = year, y = combined_volume)) +
  ...
  geom_vline(xintercept = 2023, linetype = "dashed", color = "red") + 
  theme_minimal() +
    annotate("text", x = 1975, y = 900000000, label = "-3.46 * 10^5 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
...
ggplot(data = neuse, aes(x = year, y = volume)) +
  ...
  geom_vline(xintercept = 2023, linetype = "dashed", color = "red") + 
  theme_minimal() +
  annotate("text", x = 2034, y = 2000000000, label = "-1.09 * 10^7 * x cfs/year", size = 2.5,
           family = "Times New Roman") +
